    ...
    def decide_on_actions(self, state):
        ...
        while True:
            ...
            if Phase.INTRO1 == self._phase:
                ...
                So you can only see as far as 2 grid cells. Therefore, it is important to search the areas well. If you moved down twice, press the "Continue" button.',
                                  'RescueBot')
                if self.received_messages_content and self.received_messages_content[-1] == 'Continue':
            ...
            if Phase.INTRO2 == self._phase:
                ...
                If you pressed the button "03" and moved to the area entrance, press the "Continue" button.',
                                  'RescueBot')
                if self.received_messages_content and self.received_messages_content[-1] == 'Continue':
            ...
            if Phase.INTRO3 == self._phase:
                ...
                If you found critically injured elderly woman and informed me about it, press the "Continue" button. I will then come over to help.',
                                  'RescueBot')
                if self.received_messages_content and self.received_messages_content[-1] == 'Continue':
            ...
            if Phase.INTRO5 == self._phase:
                ...
                I will then come over to help. If you informed me and I arrived at area 5 to help, press the "Continue" button.',
                                  'RescueBot')
                if self.received_messages_content and self.received_messages_content[-1] == 'Continue':
            ...
            if Phase.INTRO6 == self._phase:
                ...
                Now, you will see a small busy icon untill rock is successfully removed. If the entrance is cleared, press the "Continue" button.',
                                  'RescueBot')
                if self.received_messages_content and self.received_messages_content[-1] == 'Continue':
            ...
            if Phase.INTRO9 == self._phase:
                ...
                So, no need to keep clicking buttons! If the entrance is cleared, press the "Continue" button.',
                                  'RescueBot')
                if self.received_messages_content and self.received_messages_content[-1] == 'Continue':
            ...
            if Phase.INTRO10 == self._phase:
                ...
                if self.received_messages_content and self.received_messages_content[
                    -1] == 'Found: critically injured girl in 5':
                    self._phase = Phase.FIND_NEXT_GOAL
                    self.received_messages_content = []
                    self.received_messages = []
                else:
                    ...
                    if action != None:
                        ...
                        for info in state.values():
                            if 'class_inheritance' in info and 'ObstacleObject' in info[
                                'class_inheritance'] and 'stone' in info['obj_id'] and info['location'] not in [(9, 7),
                                                                                                                (9, 19),
                                                                                                                (21,
                                                                                                                 19)]:
            ...
            if Phase.REMOVE_OBSTACLE_IF_NEEDED == self._phase:
                ...
                for info in state.values():
                    if 'class_inheritance' in info and 'ObstacleObject' in info['class_inheritance'] and 'rock' in info[
                        ...
                        if self._tutorial and self.received_messages_content and self.received_messages_content[
                            -1] == 'Continue':
                            self._phase = Phase.INTRO6
                            self.received_messages_content = []
                            self.received_messages = []
        ...
        for mssgs in receivedMessages.values():
            for msg in mssgs:
                ...
                if msg.startswith('Remove:'):
                    ...
                    self._sendMessage('Moving to ' + str(self._door['room_name']) + ' to help you remove an obstacle.',
                                      'RescueBot')
